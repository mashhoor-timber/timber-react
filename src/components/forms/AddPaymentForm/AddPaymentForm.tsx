...
const clientCreateMethodMap = {
  invoice: (client: ReturnType<typeof useTimberClient>) =>
    client.invoicePayment.create,
  bill: (client: ReturnType<typeof useTimberClient>) =>
    client.billPayment.create,
} as const;

const fetchMethodMap = {
  invoice: (client: ReturnType<typeof useTimberClient>, id: string) =>
    client.invoice.get(id),
  bill: (client: ReturnType<typeof useTimberClient>, id: string) =>
    client.vendorPayment.get(id),
} as const;
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Input
          ...
          description={`Amount Due: ${formatCurrency(
            invoice.amount_due - invoice.postdated_payment!!,
            invoice.currency
          )}`}
          name="amount"
          type="number"
